...
public class ItemVariantGroup<VARIANT extends Enum<VARIANT> & StringRepresentable, ITEM extends Item> implements IItemVariantGroup<VARIANT, ITEM> {
	 ...
	 */
	@FunctionalInterface
	public interface ItemFactory<VARIANT extends Enum<VARIANT> & StringRepresentable, ITEM extends Item> {
	...
	public static class Builder<VARIANT extends Enum<VARIANT> & StringRepresentable, ITEM extends Item> {
		 ...
		 */
		public static <VARIANT extends Enum<VARIANT> & StringRepresentable, ITEM extends Item> ItemVariantGroup.Builder<VARIANT, ITEM> create(final DeferredRegister<Item> items) {
