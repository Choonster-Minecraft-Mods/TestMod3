...
public class ModBowItem extends BowItem {
	 ...
	 * @return The result
	 */
	protected InteractionResult nockArrow(final ItemStack bow, final Level world, final Player shooter, final InteractionHand hand) {
	 ...
	 */
	protected boolean fireArrow(final ItemStack bow, final Level level, final LivingEntity shooter, int charge) {
	...
	public boolean releaseUsing(final ItemStack stack, final Level level, final LivingEntity entity, final int timeLeft) {
		if (entity instanceof final Player player) {
			...
			return fireArrow(stack, level, player, charge);
		}
