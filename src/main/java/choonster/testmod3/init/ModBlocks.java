	...
	public static class RegistrationHandler {
		...
		public static void registerBlocks(final RegistryEvent.Register<Block> event) {
			...
			final Block[] blocks = {
					...
					new BlockSurvivalCommandBlock(TileEntityCommandBlock.Mode.REDSTONE, Block.Properties.from(Blocks.COMMAND_BLOCK)).setRegistryName("survival_command_block"),
					new BlockSurvivalCommandBlock(TileEntityCommandBlock.Mode.AUTO, Block.Properties.from(Blocks.REPEATING_COMMAND_BLOCK)).setRegistryName("repeating_survival_command_block"),
					new BlockSurvivalCommandBlock(TileEntityCommandBlock.Mode.SEQUENCE, Block.Properties.from(Blocks.CHAIN_COMMAND_BLOCK)).setRegistryName("chain_survival_command_block"),
