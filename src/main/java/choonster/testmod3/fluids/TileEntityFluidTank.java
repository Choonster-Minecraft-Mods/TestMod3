...
public class TileEntityFluidTank extends FluidTank {
	...
	public TileEntityFluidTank(final TileEntity tileEntity, final FluidStack stack, final int capacity) {
		super(stack, capacity);
		tile = tileEntity;
	}

	public TileEntityFluidTank(final TileEntity tileEntity, final Fluid fluid, final int amount, final int capacity) {
