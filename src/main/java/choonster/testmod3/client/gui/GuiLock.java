...
public class GuiLock extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		drawCenteredString(fontRendererObj, I18n.format("testmod3:lock.set_lock_code"), width / 2, 20, 0xffffff);
		drawString(fontRendererObj, I18n.format("testmod3:lock.lock_code"), width / 2 - 150, 37, 0xa0a0a0);
